...
JournaldLoggerProcess::JournaldLoggerProcess(const Flags& _flags)
...
Future<Nothing> JournaldLoggerProcess::run()
{
...
void JournaldLoggerProcess::loop()
{
  static int runcount = 0;

  std::cerr << "Loop run number " << runcount++ << "\n";
...
Try<Nothing> JournaldLoggerProcess::write_journald(size_t readSize)
{
...
Try<Nothing> JournaldLoggerProcess::write_logrotate(size_t readSize)
{
...
void JournaldLoggerProcess::rotate()
{
  if (leading.isSome()) {
